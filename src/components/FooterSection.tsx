    ...
    <footer className="border-t border-border py-10">
      <div className="section-container flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-4">
          <a
            href="https://github.com/dhananjaya0013"
            target="_blank"
          ...
          <a
            href="https://www.instagram.com/dhananjaya_poojary24?igsh=MXdtYzJnbm4weTV0cA=="
            target="_blank"
            rel="noopener noreferrer"
            className="text-muted-foreground hover:text-primary transition-colors"
          ...
          <a
            href="https://www.linkedin.com/in/dhananjaya-poojary-232057379"
            target="_blank"
            rel="noopener noreferrer"
            className="text-muted-foreground hover:text-primary transition-colors"
            aria-label="LinkedIn"
          ...
          <a
            href="mailto:dhananjayapoojary.official@gmail.com"
            className="text-muted-foreground hover:text-primary transition-colors"
            aria-label="Email"
          >
            <Mail size={18} />
